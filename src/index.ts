/**
 * @file JSONRPC 2.0 request authentication with taiyi authorities.
 * @author Hongzhong <🀄️@zuowangdao.com>
 */

import {hexify, PrivateKey} from '@taiyinet/libcrypto'
import {createHash, randomBytes} from 'crypto'

/**
 * Signing constant used to reserve opcode space and prevent cross-protocol attacks.
 * Output of `sha256('taiyi_jsonrpc_auth')`.
 */
export const K = Buffer.from('7701ccaaa966600b83b68937a077587941fd9ab1ff144e396eb4239df7a8a06b', 'hex')
 ...
 * @param account    Taiyi account name that is the signer.
 ...
 *
 * Responsible for:
 *   1. Account must be a valid taiyi blockchain account
